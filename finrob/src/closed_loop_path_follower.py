...
def start_node(): 
    ...
    sub_mtr_disable = rospy.Subscriber('/mtr_disable', Bool, set_mtr_disable)
...
def set_mtr_disable(msg_in):
    global mtr_disable
    mtr_disable = msg_in.data
...
def path_follow(pose_msg_in):
    ...
    global estimated_pose, path_segment_spec, mtr_disable
